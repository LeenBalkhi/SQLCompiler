...
public interface SqlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code tableAsValue}
	 * labeled alternative in {@link SqlParser#value}.
	 * @param ctx the parse tree
	 */
	void enterTableAsValue(SqlParser.TableAsValueContext ctx);
	/**
	 * Exit a parse tree produced by the {@code tableAsValue}
	 * labeled alternative in {@link SqlParser#value}.
	 * @param ctx the parse tree
	 */
	void exitTableAsValue(SqlParser.TableAsValueContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SqlParser#file}.
	 * @param ctx the parse tree
	 */
	void enterFile(SqlParser.FileContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlParser#file}.
	 * @param ctx the parse tree
	 */
	void exitFile(SqlParser.FileContext ctx);
	/**
