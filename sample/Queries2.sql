...
create type country( Number id,  String name, region region);
create type city( Number id,  String name, country country);
...
create aggregation_function max("<your jar path>","<your className>","<your methodName>",number,[number]);
create aggregation_function stdev("<your jar path>","<your className>","<your methodName>",number,[number]);
